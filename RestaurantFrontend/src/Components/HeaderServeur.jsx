...
const HeaderServeur = () => {
    ...
    return (
      ...
      <Nav className="navbar">
                <a href="/dashboard-serveur" className={location.pathname === "/dashboard-serveur" ? "active" : ""}><b>Dashboard</b></a>
                <a href="/consulter-commande-serveur" className={location.pathname === "/consulter-commande-serveur" ? "active" : ""}><b>Commande</b></a>
                <a href="/profile-serveur" className={location.pathname === "/profile-serveur" ? "active" : ""}><b>Profile</b></a>
